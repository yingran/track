...
export default class Ground extends RigidBody {
    ...
    constructor( world: World, width: number, depth: number, friction: number = 2, material: THREE.MeshPhongMaterial = new THREE.MeshPhongMaterial( { color: RigidBody.DEFAULT_COLRO } ) ) {
